        ...
        <div className="page">
            <div className="tour-cv">
                <span className="top-cv">
                    ...
                    <span className="en-tete" id="en-tete">
                ...
                <div className="section-cv">
                    <h2 className="h2-profil" id="h2-profil">PROFIL</h2>
                    ...
                    <h2 className="parcours" id="parcours">PARCOURS PROFESSIONNEL</h2>
                    ...
                    <h2 className="formations" id="formations">FORMATIONS</h2>
